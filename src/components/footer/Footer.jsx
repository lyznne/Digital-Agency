                                ...
                                <div className="f-item contact">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div className="content">
                                                <strong>Email:</strong>
                                                <a href="mailto:emuthiani26@gmail.com">emuthiani26@gmail.com</a>
                                            </div>
                                        </li>
                                        <li>
                                            <div className="content">
                                                <strong>Phone:</strong>
                                                <a href="tel:254753579988">+254 57539988</a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <p>
                                    Copyright &copy; {(new Date().getFullYear())} LYZNNE's. All Rights Reserved
                                </p>
                            </div>
                        </div>
                    </div>
