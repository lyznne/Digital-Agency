                        ...
                        <div>
                            <ul>
                                ...
                                <li>
                                    <div className="content">
                                        <p>Email</p>
                                        <strong><a href="mailto:emuthiani26@gmail.com" className='color-para'>emuthiani26@gmail.com</a></strong>
                                    </div>
                                </li>
                                <li>
                                    <div className="content">
                                        <p>Contact</p>
                                        <strong><a href="tel:+254-75-753-9988" className='color-para'>+254-75-753-9988</a></strong>
                                    </div>
                                </li>
                            </ul>
                        </div>
